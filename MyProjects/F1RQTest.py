...
# Para exibir e fazer funcionar o quiz é preciso percorres as perguntas, as alternativas e as respostas corretas de cada item do quiz
...
# Cada questão é um dicionário que contém os dados da questão do quiz (pergunta(enunciado da questão), alternativas e resposta correta)

# Percorre cada item (questão) do quiz
for questao in quiz:
    # print(f"Questão {quiz.index(questao)+1}: {quiz[i]["pergunta"]}")
    print(questao)